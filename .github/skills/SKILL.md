...
1. Foundation and contracts -> [fastapi-foundation-contracts](./fastapi-foundation-contracts/SKILL.md)
2. Auth and route security -> [fastapi-auth-security](./fastapi-auth-security/SKILL.md)
3. Data and CRUD semantics -> [fastapi-data-crud-patterns](./fastapi-data-crud-patterns/SKILL.md)
4. External integration reliability -> [fastapi-integration-reliability](./fastapi-integration-reliability/SKILL.md)
5. GenAI architecture and safety -> [fastapi-genai-application-patterns](./fastapi-genai-application-patterns/SKILL.md)
6. Testing and quality -> [fastapi-testing-quality](./fastapi-testing-quality/SKILL.md)
7. Observability and runtime ops -> [fastapi-observability-operations](./fastapi-observability-operations/SKILL.md)
8. Release checks and docs -> [fastapi-release-gates](./fastapi-release-gates/SKILL.md)
